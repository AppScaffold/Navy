...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        favoriteVC.view.backgroundColor = UIColor.white

        let downloadVC = DownloadViewController()
        downloadVC.title = "Download"
        downloadVC.view.backgroundColor = UIColor.white

        let historyVC = HistoryViewController()
        historyVC.title = "History"
        historyVC.view.backgroundColor = UIColor.white
        ...
        let controllers = [favoriteVC, downloadVC, historyVC]
