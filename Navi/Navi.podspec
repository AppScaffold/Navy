...
Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://gitlab.fftech.info/dragon/consumer-app/navi-client-ios'
  s.license      = 'Private'
  s.platform     = :ios, '9.0'
  s.source       = { :git => 'git@gitlab.fftech.info:dragon/consumer-app/navi-client-ios.git', :tag => s.version }
